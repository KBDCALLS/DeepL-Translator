...
class App : Application() {
    ...
    private fun switchTheme() {
        ...
        var darkThemeMode = config.getString(getString(R.string.key_dark_mode), AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM.toString())!!
    ...
    private fun removeOldAppShortcut() {
        ...
        // Used to launch this app with darkTheme or lightTheme.
        shortcutManager.removeDynamicShortcuts(listOf("theme"))
    }
}